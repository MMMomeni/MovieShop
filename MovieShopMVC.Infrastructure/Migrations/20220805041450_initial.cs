        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "varchar(MAX)", nullable: true),
                    TmdbUrl = table.Column<string>(type: "varchar(MAX)", nullable: true),
                    ProfilePath = table.Column<string>(type: "varchar(2048)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Department = table.Column<string>(type: "varchar(128)", nullable: false),
                    job = table.Column<string>(type: "varchar(128)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewText = table.Column<string>(type: "varchar(MAX)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    TrailerId = table.Column<string>(type: "varchar(2084)", nullable: false),
                    Name = table.Column<string>(type: "varchar(2084)", nullable: true)
                },
                constraints: table =>
                {
